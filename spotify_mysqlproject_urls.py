...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='e823dc6ec76d47e8a3016ceed295db84',   #Replace with your Client ID
    client_secret='27679a42d2cc4aa38b8a3185327302c2'  # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': 'KART2003',   # Replace with your MySQL password
    'database': ' analystproject1'       # Replace with your database name
}
